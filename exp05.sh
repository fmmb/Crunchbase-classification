...
./bin/createarff.py $EXP/most-relevant-words.txt exp01.42tags/train.json.gz | gzip > $EXP/train.arff.gz
./bin/createarff.py $EXP/most-relevant-words.txt $EXP/train.arff.gz exp01.42tags/test.json.gz | gzip > $EXP/test.arff.gz
./bin/createarff.py $EXP/most-relevant-words.txt $EXP/train.arff.gz exp01.42tags/devel.json.gz | gzip > $EXP/devel.arff.gz
