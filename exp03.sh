...
# Correct 6480/17910, ACCURACY: 0.361809 (K=120, PARETO)
# Correct 7278/17910, ACCURACY: 0.406365 (K=500) 32,545 total
# Correct 5962/17910, ACCURACY: 0.332887 (K=120, FP2: FP also for companies, PARETO) 36,604 total

./bin/topic_tfidf.py $EXP/train.json.gz $EXP/devel.json.gz | ./bin/evaluate.py $EXP/devel.ref
# Correct 6881/17910, ACCURACY: 0.384199 (freqmin=18) 30,582 total
